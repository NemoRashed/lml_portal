          ...
          <table className="table-auto min-w-full">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border px-4 py-2 lg:w-1/4">Types of Services</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="border px-4 py-2 lg:w-1/4 ">Repair</td>
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">BuyBack</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">Software</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">Cleaning</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">Diagnostics</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">Unlock</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
              ...
              <tr>
                <td className="border px-4 py-2 text-center">1</td>
                <td className="border px-4 py-2 lg:w-1/4 ">Customation</td>
                <td className="border px-4 py-2 lg:w-1/4 pl-28">
                  <Image src="/favicon.png" alt="logo" width={25} height={25} />
                </td>
                <td className="border px-4 py-2 w-full  gap-4 flex justify-center items-center pl-7 pb-6">
